...
| *dynatrace_wsagent_linux_installer_file_name* | dynatrace-wsagent-linux-x64.tar                                        | The file name of the Dynatrace Web Server Agent installer in the role's ```files``` directory. |
| *dynatrace_wsagent_linux_installer_file_url*  | http://downloads.dynatracesaas.com/6.3/dynatrace-wsagent-linux-x64.tar | A HTTP, HTTPS or FTP URL to the Dynatrace Web Server Agent installer in the form (http\|https\|ftp)://[user[:pass]]@host.domain[:port]/path. |
